...
public class speakAdapter  extends ArrayAdapter<speak> {

    /** Resource ID for the background color for this list of words */
    private int mColorResourceId;

    /**
     * Create a new {@link speakAdapter} object.
     */
    public speakAdapter(Context context, ArrayList<speak> words, int colorResourceId) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        speak currentWord = getItem(position);
